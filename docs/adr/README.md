...
- [0071 — Project Provider and Model catalogs from the active Generation](0071-project-provider-and-model-catalogs-from-the-active-generation.md)
- [0072 — Expose a searchable local Plugin catalog](0072-expose-a-searchable-local-plugin-catalog.md)
- [0073 — Compose bounded GitHub workflows over Process](0073-compose-bounded-github-workflows-over-process.md)
...
- [0080 — Default Agent Loop cumulative quotas to unlimited](0080-default-agent-loop-cumulative-quotas-to-unlimited.md)
- [0081 — Resolve model metadata into each Turn](0081-resolve-model-metadata-into-each-turn.md)
- [0082 — Trigger Context Compaction from model input capacity](0082-trigger-context-compaction-from-model-input-capacity.md)
- [0083 — Separate Turn selection from Generation authority](0083-separate-turn-selection-from-generation-authority.md)
- [0084 — Switch Profile modes through the Generation Ready Gate](0084-switch-profile-modes-through-the-generation-ready-gate.md)
...
- [0110 — Authenticated Session ownership](0112-authenticated-session-ownership.md)
