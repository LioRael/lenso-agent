...
This boundary supersedes ADR-0096's catalog-driven Generation reconciliation.
...
|---|---|---|
| `provider_id`, `provider_instance` | leased Generation and current Host catalog | `turn_started.resolved_turn_profile` |
...
| `catalog_provenance` | Provider acquisition metadata and freshness policy | `turn_started.resolved_turn_profile` |
