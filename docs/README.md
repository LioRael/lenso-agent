...
- Explanation: [Agent Harness v1 architecture](architecture/agent-harness-v1.md) and the focused Module cards under `architecture/`.

The root README is the runnable entry point. Architecture rationale belongs in
`architecture/`; decisions that constrain future changes belong in `adr/`.
