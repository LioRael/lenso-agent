# Configure Lenso Agent

[Back to the README](../README.md) · [Documentation map](README.md)

Configure Profiles, models, storage, Tools, and Plugins after completing the
...
Generic App-management commands require the separate
[Lenso CLI](https://github.com/LioRael/lenso-cli) and operate on their current directory,
...
## Terminal sessions and interaction
...
The coding Profiles load `AGENTS.md` from the repository root through the current
...
These management commands require the separate [Lenso CLI](https://github.com/LioRael/lenso-cli).
...
```sh
lenso plugins add path/to/uppercase/dist/uppercase-0.1.10.lenso-plugin
...
[10-minute Tool Plugin tutorial](tutorials/10-minute-tool-provider.md).
