...
pub use lenso_agent_console_plugin_tools_plugin::{
    APPLY_PLUGIN_CHANGE_TOOL, APPLY_PLUGIN_ROLLBACK_TOOL, CHECK_PLUGIN_CHANGE_TOOL,
    CHECK_PLUGIN_ROLLBACK_TOOL, INSPECT_APP_TOOL, INSPECT_PLUGIN_TOOL, LIST_PLUGIN_CHANGES_TOOL,
    LIST_PLUGINS_TOOL, SET_PLUGIN_ENABLED_TOOL,
};

/// First-party Plugin management Tools available to the Console Agent.
pub const PLUGIN_CONTROL_TOOLS: [&str; 9] = [
    INSPECT_APP_TOOL,
    LIST_PLUGINS_TOOL,
    INSPECT_PLUGIN_TOOL,
