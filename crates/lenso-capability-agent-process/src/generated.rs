...
#[doc(hidden)]
#[macro_export]
macro_rules! __lenso_provided_process { () => { "{\"capability_id\":\"lenso.agent.process@1\",\"descriptor_version\":\"1.0.0\",\"operations\":[\"catalog\",\"run\"],\"operation_kinds\":{},\"default_admission\":{\"queue_capacity\":0,\"max_concurrency\":1},\"operation_admissions\":{},\"event_admission\":null,\"cross_lane_transfer\":false}" }; }
