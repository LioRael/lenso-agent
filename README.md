...
# exact origins, and the headless-network App must select those same origins in
...
an allowlist containing that scope. The checked-in `headless-network` App keeps
