export declare const PROCESS_PROFILE: "lenso-process-jsonrpc-http-v1";
export declare const VALUE_PROFILE: "lenso-json-value-v1";
export declare const PROVIDE_REQUEST_PROFILE: "provide-request-v1";
export declare const HANDSHAKE_METHOD: "lenso.process.v1.handshake";
export declare const REQUEST_METHOD: "lenso.process.v1.request";
export declare const CANCEL_METHOD: "lenso.process.v1.cancel";
export declare const SHUTDOWN_METHOD: "lenso.process.v1.shutdown";
...
export type ProcessOutcome = {
    ...
    readonly failure: ChildRuntimeFailure;
};
